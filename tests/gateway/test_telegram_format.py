"""Tests for Telegram HTML rendering and chunking helpers."""
...
from gateway.outbound.service import send_telegram_text  # noqa: E402
...
class TestSendTelegramText:
    ...
    def test_send_uses_html_chunks_and_preserves_reply_and_thread(self, config):
    ...
    def test_html_parse_failure_retries_with_plain_text(self, config):
        calls = []
